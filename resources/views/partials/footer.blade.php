    ...
    <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2">
                    <li><a class="text-base text-slate-600 hover:text-[#1173d4]" href="{{route('contact.index')}}" wire:navigate>Contact Us</a></li>
                    <li><a class="text-base text-slate-600 hover:text-[#1173d4]" href="#">FAQ</a></li>
                    <li><a class="text-base text-slate-600 hover:text-[#1173d4]" href="{{route('terms.index')}}"  wire:navigate >Terms & Conditions</a></li>
                </ul>
            </div>
        </div>
