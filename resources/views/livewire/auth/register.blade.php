        ...
        <div class="w-full max-w-md space-y-8">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">
                    ...
                    <a class="font-medium text-[#1173d4] hover:text-[#0f63b9]" href="{{ route('login') }}"
            ...
            <form method="POST" wire:submit="register" class="mt-4 space-y-6">
                <div class="rounded-md shadow-sm -space-y-px">
                    ...
                    <div class="relative">
                        ...
                        <input id="password_confirmation" name="password_confirmation" type="password"
                            autocomplete="new-password" wire:model.defer="password_confirmation" required
                ...
                <div>
                    <button type="submit"
                        class="group relative flex w-full justify-center rounded-md bg-[#1173d4] py-3 px-4 text-sm font-semibold text-white hover:bg-[#0f63b9] focus:outline-none focus:ring-2 focus:ring-[#1173d4] focus:ring-offset-2">Create
                        account</button>
                </div>
            </form>
