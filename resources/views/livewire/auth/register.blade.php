<div class="flex flex-col md:flex-row min-h-screen">
    ...
    <div class="w-full md:w-1/2 bg-gray-100 flex flex-col justify-center items-center p-8 lg:p-12 relative">
        ...
        <div class="max-w-md text-center">
            ...
            <h2 class="text-3xl font-bold text-gray-800 mt-8">Drive with Confidence</h2>
            <p class="text-gray-600 mt-4">Create your account to book cars, manage trips and access member benefits.</p>
        </div>
    </div>
